package demo.fc.lifecycle.config;

import demo.fc.lifecycle.service.impl.RocketMQConsumeMsgListenerProcessor;
...
public class RocketMQConsumerConfig {
    ...
    @Autowired
    private RocketMQConsumeMsgListenerProcessor consumeMsgListenerProcessor;
    /**
     * mq 消费者配置
     * @return
